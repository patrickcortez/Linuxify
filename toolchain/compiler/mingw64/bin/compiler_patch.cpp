// Compiler Patch - Enforce No Comment Policy
// Uses standard C++98/11 features to avoid filesystem dependency issues
#include <iostream>
#include <string>
#include <vector>
#include <fstream>
...
int main(int argc, char* argv[]) {
    // 1. Get location of real compiler
    ...
    // 2. Scan arguments for source files
